import {type Product, productOptions, usageConditionStyle, usageOptions} from "../../products.ts";
                ...
                <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
                    ...
                    <div className="p-6 my-2">
                        <div className="flex justify-between items-center">
                            ...
                            <span
                                className={`inline-block px-3 py-1  rounded-full text-sm ${usageConditionStyle[product.usageCondition]}`}>
